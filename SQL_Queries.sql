/*
INTRODUCTION: 
A company Axon, which is a retailer selling classic cars, is managing and analyzing their sales data. 
...
To address this issue, the company has decided to do data analysis to manage and analyze their sales data effectively. 
The goal of this is to do advance analytics in SQL on the data and extract insights that can help the company improve its sales.
*/

USE classicmodel;							# Selecting database to work
